...
<body>
<form name="loginform" action="zgjs_biaoge_act.jsp" method="post" onsubmit="return formsubmit('document.loginform','1')" target="_self" >
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"><img src="../images/ri_list.jpg" width="14" height="14" align="absbottom" />&nbsp;您现在所在的位置：<font color="#0e7cc9">中国专利检索</font> &gt; 表格检索 </td>
  </tr>
</table>
													...
													<td>
														<table width="100%" border="0" cellspacing="0" cellpadding="0" class="listtit2">
															...
															<table width="439" border="0" cellpadding="0" cellspacing="0">
                                                              <tr>
                                                                <td><input type="checkbox" value="fmzl_ab" id="strdb" name="strdb" checked="checked" />
                                                                    <label for="strdb" style="cursor:hand">发明专利</label></td>
                                                                <td><input type="checkbox" value="wgzl_ab" id="strdb2" name="strdb" checked="checked" />
                                                                    <label for="strdb2" style="cursor:hand">外观专利</label></td>
                                                                <td><input type="checkbox" value="syxx_ab" id="strdb4" name="strdb" checked="checked" />
                                                                    <label for="strdb4" style="cursor:hand">实用新型</labl> </td>
                                                                <td><input type="checkbox" value="fmsq_ab" id="strdb22" name="strdb" checked="checked" />
                                                                    <label for="strdb22" style="cursor:hand">发明授权</label>
                                                              </td>
                                                              </tr>
                                                            </table></td>
															<tr>
												...
												<tr>
												  <td height="30">
														<TABLE width="100%" border=0 align="center" cellPadding=2 cellSpacing=0  class="t1">
															<TBODY>
																<TR bgColor=#ffffff>
 <TD UNSELECTABLE="On" align=left width="13%" height=32 background="../images/index_11.gif" title="点击在组合逻辑检索中加入此字段代码" onClick="Click('A');" style="cursor: hand">
							<input type="button"  id="a" class="tablebutton" value="A:申     请    号">	
								 </TD>
															<TD width="20%" height=32>
<INPUT id="txtA" name="an" size="20%"  class="tab_ipt" alt="&nbsp;&nbsp;&nbsp;&nbsp;申请号字段检索支持<B><font color=red>?</font></B>代替单个字符,<B><font color=red>%</font></B>代替多个字符,字段内各检索词之间进行<B><font color=red>and</font></B>、<B><font color=red>or</font></B>运算<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、输入完整申请号，如键入：<B><font color=red>CN02144686.5</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知申请号前五位为02144，应键入：<B><font color=red>CN02144%</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、已知申请号中间几位为2144，应键入：<B><font color=red>%2144%</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;4、已知申请号不连续的几位为021和468，应键入：<B><font color=red>%021%468%</font></B>"></TD>
								<TD UNSELECTABLE="On" align=center width="11%" height=32 background="../images/index_11.gif"
								title="点击在组合逻辑检索中加入此字段代码" onClick="Click('B');" style="cursor: hand">
                                                 <input type="button"  class="tablebutton" value="B:申　请　 日"></TD>
																	<TD width="20%" height=32>
																  <INPUT id="txtB" name="ad" size="20%"  class="tab_ipt"  alt="&nbsp;&nbsp;&nbsp;&nbsp;申请日由年、月、日三部分组成，模糊部分可直接略去（不用模糊字符）。<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、申请日为2002年01月01日，，可键入：<B><font color=red>20020101</font></B>或<B><font color=red>2002.01.01</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、申请日为2002年01月，可键入：<B><font color=red>200201</font></B>或<B><font color=red>2002.01</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、申请日为2002年某月01日，可键入：<B><font color=red>2002..01</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;4、申请日为某年01月01日，可键入：<B><font color=red>.01.01</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;5、检索申请日为从2002年到2003年的信息，可键入：<B><font color=red>2002 to 2003</font></B>">
																  </TD>
																	<TD UNSELECTABLE="On" align=left width="14%" height=32
																		background="../images/index_11.gif"
																		title="点击在组合逻辑检索中加入此字段代码" onClick="Click('C');"
																		style="cursor: hand">
																		<input type="button"  class="tablebutton" value="C:公 开(公告)号">
																		</TD>
															
																	<TD width="22%" height=32>
<INPUT id="txtC" name="pnm" size="20%" class="tab_ipt" alt="&nbsp;&nbsp;&nbsp;&nbsp;公开（公告）号字段支持模糊检索。模糊部分位于公开（公告）号起首或中间时应使用<B><font color=red>?</font></B>代替单个字符,<B><font color=red>%</font></B>代替多个字符,位于公开（公告）号末尾时模糊字符可省略。字段内各检索词之间可进行<B><font color=red>and</font></B>、<B><font color=red>or</font></B>运算<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知公开（公告）号为CN1387751，应键入：<B><font color=red>CN1387751</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知公开（公告）号前面几位为CN13877，可键入：<B><font color=red>CN13877%</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、已知公开（公告）号中包含13877，可键入：<B><font color=red>%13877</font></B>">
</TD>
																</TR>
																<TR bgColor=#ffffff>
																	...
																	<TD UNSELECTABLE="On" align="left" width="13%" height=32
																		background="../images/index_11.gif"
																		title="点击在组合逻辑检索中加入此字段代码" onClick="Click('D');"
																		style="cursor: hand">
                                                            <input type="button"  class="tablebutton" value="D:公  开 (公 告) 日"></TD>
																	<TD height=32>
																  ...
																  <TD UNSELECTABLE="On" align=center width="11%" height=32
																		background="../images/index_11.gif"
																		title="点击在组合逻辑检索中加入此字段代码" onClick="Click('E');"
																		style="cursor: hand">
                                                 <input type="button"  class="tablebutton" value="E:名　　　 称">	</TD>
																	<TD height=32>
																  <INPUT size="20%" id="txtE"   class="tab_ipt" name="ti" alt="&nbsp;&nbsp;&nbsp;&nbsp;名称字段支持模糊检索，模糊检索时应尽量选用关键字，以免检索出过多无关文献。模糊部分位于字符串中间时应使用<B><font color=red>?</font></B>代替单个字符,<B><font color=red>%</font></B>代替多个字符，位于字符串起首或末尾时模糊字符可省略。字段内各检索词之间可进行<B><font color=red>and</font></B>、<B><font color=red>or</font></B>运算<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知名称中包含computer，可键入：<B><font color=red>computer</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知名称中包含computer和System，可键入：<B><font color=red>computer and system</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、已知名称中包含computer或system，可键入：<B><font color=red>computer or system</font></B>"></TD>
																	<TD UNSELECTABLE="On" align=left width="14%" height=32
																		background="../images/index_11.gif"
																		title="点击在组合逻辑检索中加入此字段代码" onClick="Click('F');"
																		style="cursor: hand">
		 														 <input type="button"  class="tablebutton" value="F:摘        要">  </TD>
																	<TD height=32>
																...
																<TR bgColor=#ffffff>
																	<TD UNSELECTABLE="On" align=left width="13%" height=32
																		...
																		style="cursor: hand">
																	<input type="button"  class="tablebutton" value="G:主   分  类  号"> </TD>
																	<TD height=32>
																  <INPUT id="txtG" name="pic" class="tab_ipt"  size="20%" alt="&nbsp;&nbsp;&nbsp;&nbsp;同一专利申请案具有若干个分类号时，其中第一个称为主分类号。主分类号可实行模糊检索。模糊部分应使用<B><font color=red>%</font></B>代替。 <BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知主分类号为A43B5/04，应键入：<B><font color=red>A43B5/04</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知主分类号起首部分为A43B5，应键入：<B><font color=red>A43B5%</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、已知主分类号中包含B5/04，应键入：<B><font color=red>%B5/04%</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;4、已知主分类号中包含B5和04，应键入：<B><font color=red>%B5%04</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;5、若检索主分类号为A43B5/04或A01N43/56，应键入：<B><font color=red>A43B5/04 or A01N43/56</font></B>'" value=""></TD>

																  <TD UNSELECTABLE="On" align=center width="11%" height=32
																		background="../images/index_11.gif"
																		title="点击在组合逻辑检索中加入此字段代码" onClick="Click('H');"
																		style="cursor: hand">
																<input type="button"  class="tablebutton" value="H:分　类　 号">  </TD>
																	<TD height=32>
																  <INPUT size="20%" id="txtH" class="tab_ipt"  name="sic" alt="&nbsp;&nbsp;&nbsp;&nbsp;专利申请案的分类号可由《国际专利分类表》查得。主分类号字段支持模糊检索。模糊部分应使用<B><font color=red>%</font></B>代替。 <BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知分类号为A43B5/04，应键入：<B><font color=red>A43B5/04</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知分类号起首部分为A43B5，应键入：<B><font color=red>A43B5%</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、已知分类号中包含B5/04，应键入：<B><font color=red>%B5/04%</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;4、已知分类号中包含B5和04，应键入：<B><font color=red>%B5%04</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;5、若检索分类号为A43B5/04或A01N43/56，应键入：<B><font color=red>A43B5/04 or A01N43/56</font></B>"></TD>
																	<TD UNSELECTABLE="On" align=left width="14%" height=32
																		background="../images/index_11.gif"
																		title="点击在组合逻辑检索中加入此字段代码" onClick="Click('I');"
																		style="cursor: hand">
  																<input type="button"  class="tablebutton" value="I:申请(专利权)人">  </TD>
																	<TD height=32>
																...
																<TR bgColor=#ffffff>
																	...
																	<TD UNSELECTABLE="On" align=left width="13%" height=32
																		...
																		style="cursor: hand">
																 <input type="button"  class="tablebutton" value="J:发  明 (设 计) 人">		</TD>	
																	<TD height=32>
	...
	<TD UNSELECTABLE="On" align=center width="11%" height=32	background="../images/index_11.gif" title="点击在组合逻辑检索中加入此字段代码" onClick="Click('K');" style="cursor: hand">
																 <input type="button"  class="tablebutton" value="K:主　权　 项"> </TD>
																	<TD height=32>
	<INPUT size="20%" id="txtK" class="tab_ipt"  name="cl" alt="&nbsp;&nbsp;&nbsp;&nbsp;主权项字段支持模糊检索，模糊检索时应尽量选用关键字，以免检索出过多无关文献。模糊部分位于字符串中间时应使用<B><font color=red>?</font></B>代替单个字符,<B><font color=red>%</font></B>代替多个字符，位于字符串起首或末尾时模糊字符可省略。字段内各检索词之间可进行<B><font color=red>and</font></B>、<B><font color=red>or</font></B>运算<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知主权项中包含computer，可键入：<B><font color=red>computer</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知主权项中包含computer和System，可键入：<B><font color=red>computer and system</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、已知主权项中包含computer或system，可键入：<B><font color=red>computer or system</font></B>"></TD>
																	...
																	<TD UNSELECTABLE="On" align="left" width="14%"
																		...
																		style="cursor: hand">
				<input type="button"  class="tablebutton" value="L:地        址">	  </TD>
																	<TD height=22 align="left">
	<INPUT id="txtL" name="ar" size="20%" class="tab_ipt" alt="&nbsp;&nbsp;&nbsp;&nbsp;地址字段支持模糊检索，模糊检索时应尽量选用关键字，以免检索出过多无关文献。模糊部分位于字符串中间时应使用<B><font color=red>?</font></B>代替单个字符,<B><font color=red>%</font></B>代替多个字符，位于字符串起首或末尾时模糊字符可省略。字段内各检索词之间可进行<B><font color=red>and</font></B>、<B><font color=red>or</font></B>运算<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知地址中包含辽宁省鞍山市，可键入：<B><font color=red>辽宁省鞍山市</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知地址中包含辽宁省和鞍山市，可键入：<B><font color=red>辽宁省 and 鞍山市</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、已知地址中包含鞍山市或德阳市，可键入：<B><font color=red>鞍山市 or 德阳市</font></B>"></TD> </TR>
                   							<TR bgColor=#ffffff>

<TD UNSELECTABLE="On" align=left width="11%" height=32 background="../images/index_11.gif" title="点击在组合逻辑检索中加入此字段代码" onClick="Click('M');" style="cursor: hand">
						<input type="button"  class="tablebutton" value="M:专利 代 理 机构"></TD>	
													<TD height=32>
		<INPUT id="txtM" name="agc" size="20%" class="tab_ipt" alt="&nbsp;&nbsp;&nbsp;&nbsp;专利代理机构字段支持模糊检索，模糊检索时应尽量选用关键字，以免检索出过多无关文献。模糊部分位于字符串中间时应使用<B><font color=red>?</font></B>代替单个字符,<B><font color=red>%</font></B>代替多个字符，位于字符串起首或末尾时模糊字符可省略。字段内各检索词之间可进行<B><font color=red>and</font></B>、<B><font color=red>or</font></B>运算<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知专利代理机构中包含长春科宇，可键入：<B><font color=red>长春科宇</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知专利代理机构中包含长春和科宇，可键入：<B><font color=red>长春 and 科宇</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、已知专利代理机构中包含长春科宇或沈阳科苑，可键入：<B><font color=red>长春科宇 or 沈阳科苑</font></B>"></TD>

<TD UNSELECTABLE="On" align=center width="11%" height=32 background="../images/index_11.gif" title="点击在组合逻辑检索中加入此字段代码" onClick="Click('N');" style="cursor: hand">
								 <input type="button"  class="tablebutton" value="N:代　理　 人"> </TD>
																	<TD height=32>
<INPUT id="txtN" name="agt" size="20%" class="tab_ipt" alt="&nbsp;&nbsp;&nbsp;&nbsp;代理人字段支持模糊检索，模糊检索时应尽量选用关键字，以免检索出过多无关文献。模糊部分位于字符串中间时应使用<B><font color=red>?</font></B>代替单个字符,<B><font color=red>%</font></B>代替多个字符，位于字符串起首或末尾时模糊字符可省略。字段内各检索词之间可进行<B><font color=red>and</font></B>、<B><font color=red>or</font></B>运算<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知代理人中包含李恩庆，可键入：<B><font color=red>李恩庆</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知代理人中包含李恩庆和马守忠，可键入：<B><font color=red>李恩庆 and 马守忠</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、已知代理人中包含李恩庆或周秀梅，可键入：<B><font color=red>李恩庆 or 周秀梅</font></B>"></TD>

																	<TD UNSELECTABLE="On" align="left" width="11%"
																		height=32 background="../images/index_11.gif"
																		title="点击在组合逻辑检索中加入此字段代码" onClick="Click('P');"
																		style="cursor: hand">
													<input type="button"  class="tablebutton" value="P:优   先　 权">  </TD>
																	<TD height=22 align="left">
																  <INPUT id="txtP" name="pr" size="20%" class="tab_ipt" alt="&nbsp;&nbsp;&nbsp;&nbsp;优先权字段中包含表示国别的字母和表示编号的数字，支持模糊检索，模糊检索时应尽量选用关键字，以免检索出过多无关文献。模糊部分位于字符串中间时应使用<B><font color=red>?</font></B>代替单个字符,<B><font color=red>%</font></B>代替多个字符，位于字符串起首或末尾时模糊字符可省略。字段内各检索词之间可进行<B><font color=red>and</font></B>、<B><font color=red>or</font></B>运算<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知专利优先权编号为02112242，应键入：<B><font color=red>02112242</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知专利优先权国家为中国且优先权编号为02112242，应键入：<B><font color=red>CN and 02112242</font></B>">
																  </TD>   
																  </TR>
                   										      <TD UNSELECTABLE="On" align="left" width="11%"
																		height=32 background="../images/index_11.gif"
																		title="点击在组合逻辑检索中加入此字段代码" onClick="Click('Q');"
																		style="cursor: hand">
									<input type="button"  class="tablebutton" value="Q:国   省  代  码">  </TD>
																	<TD height=22 align="left">
																  <INPUT id="txtQ" name="co" size="20%" class="tab_ipt" alt="&nbsp;&nbsp;&nbsp;&nbsp;国省代码字段中包含表示国省的字母和表示编号的数字，支持模糊检索，模糊检索时应尽量选用关键字，以免检索出过多无关文献。模糊部分位于字符串中间时应使用<B><font color=red>?</font></B>代替单个字符,<B><font color=red>%</font></B>代替多个字符。<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知国省代码为江苏(32)，应键入：<B><font color=red>江苏%</font></B>或<B><font color=red>%32%</font></B><BR>"></TD>
																
																	<TD UNSELECTABLE="On" align="left" width="11%" 
																		height=32 background="../images/index_11.gif"
																		title="点击在组合逻辑检索中加入此字段代码" onClick="Click('R');"
																		style="cursor: hand">&nbsp;&nbsp;
																	&nbsp;&nbsp;&nbsp;<input type="button"  class="tablebutton" value="R:全 文 检  索">																														</TD>
																	<TD colspan="5" height=32>
													<INPUT id="txtR" name="txtR" size="20%" class="tab_ipt"alt="&nbsp;&nbsp;&nbsp;&nbsp;全文检索是对专利的权利要求书、说明书、说明书附图、附件等字段的全文信息进行检索，支持模糊检索，模糊检索时应尽量选用关键字，以免检索出过多无关文献。模糊部分位于字符串中间时应使用<B><font color=red>?</font></B>代替单个字符,<B><font color=red>%</font></B>代替多个字符，位于字符串起首或末尾时模糊字符可省略。字段内各检索词之间可进行<B><font color=red>and</font></B>、<B><font color=red>or</font></B>运算<BR><BR><B>检索示例：</B><BR>&nbsp;&nbsp;&nbsp;&nbsp;1、已知全文信息中包含计算机，可键入：<B><font color=red>计算机</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;2、已知全文信息中包含计算机和应用，可键入：<B><font color=red>计算机 and 应用</font></B><BR>&nbsp;&nbsp;&nbsp;&nbsp;3、已知全文信息中包含计算机或控制，可键入：<B><font color=red>计算机 or 控制</font></B>">
																			</TD>	</TR>
																<TR bgColor=#E8EEF4>
																	<TD colspan="6">																			
																			...
																			<INPUT type=submit value=检索 name=submit1 class="subit_2">
