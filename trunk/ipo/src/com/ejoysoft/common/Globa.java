...
public class Globa {
	...
	public static String hotpot;
	public static String enviromentCity;
	public static String enviromentHotPotName;
	public static String enviromentStartTime;
	public static String enviromentEndTime;
	...
	private int logger(String logCode, String loginName, String loginIp, String logMsg, String strOther,String unitCode) {
	    ...
	    try {
	        db.prepareStatement("INSERT  INTO sys_log (strId, Doccurdate, strOperator, strContent, strCode, strOperatorIp, strOther,strUnitCode)VALUES (?,?,?,?,?,?,?,?)");
