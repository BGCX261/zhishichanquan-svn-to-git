...
public final class Constants {
    ...
    public final static String CHA_XUN_LIANG="CHA_XUN_LIANG";
    public final static String A="an";
    public final static String B="ad";
    public final static String C="pnm";
    public final static String D="pd";
    public final static String E="ti";
    public final static String F="abst";
    public final static String G="pic";
    public final static String H="sic";
    public final static String I="pa";
    public final static String J="inn";
    public final static String K="cl";
    public final static String L="ar";
    public final static String M="agc";
    public final static String N="agt";
    public final static String P="pr";
    public final static String Q="co";
    ...
    //---------------------------------------------------------------------------------------------
    public static final String Administrator = "ipo";
    ...
    public final static String ADD_STR1 = "add1";
    public final static String RESTORE_STR = "restore";
    public final static String BACKUP_STR = "backup";
    //�޸�
    public final static String UPDATE_STR = "update";
    public final static String DELETE_IMG = "deleteimg";
     //����
