...
import com.ejoysoft.wlanyz.system.SysPara;
import com.ejoysoft.wlanyz.system.SysUserUnit;
public class InitClass  extends GenericServlet {
   ...
   public void init() {
       ...
       System.out.println(sysJndiName+"!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
       //加载数据�? 
       com.ejoysoft.common.DbConnect.initPool(sysJndiName);
       
       
       //获取系统参数CHA_XUN_LIANG
       String namberMax=scf.getInitParameter("CHA_XUN_LIANG");
       System.out.println(namberMax+"+++++++++++%%%%%%%%%%%%%%%%%%%%$$$$$$$$");
       application.setAttribute("namberMax", namberMax);
