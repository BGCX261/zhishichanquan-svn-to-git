 ...
 //      id   dOccurDate  strOperator  strContent     strCode    strOperatorIp   strOther
   ...
   //��ϸ��ʾ������?
    ...
    public boolean delete(String where) {
        try {
            String sql = "DELETE FROM sys_log" + "  ".concat(where);
    ...
    public byte[] backup(String operatorId, String startdate, String enddate) {
         ...
         * ��ʱ�ļ�����Ϊ��
         */
        path += System.currentTimeMillis() + "log.xml";                                             //�����ļ���
        /**
         * �򱸷��ļ���д��־��Ϣ
         * ��־��Ϣ����XML�ĸ�ʽ����
         */
...
//                logInfo += "<content>" + rs.getString("strContent") + "</content>\n";
    ...
    private String strCode;//					����ģ�����?
    private String strOperatorIp;//			��������ip
    private String strOther;//			��ע
