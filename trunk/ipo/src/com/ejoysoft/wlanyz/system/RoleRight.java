...
public class RoleRight {
    ...
    String strTableName = "sys_userright";
    ...
    public boolean add(String[] tArry, String tStrObjId, int tIntType) {
        ...
        if (tArry == null || tArry.length == 0) {
            ...
            // ���û��б���ѭ����ȡ��Ȼ����뵽��ݿ���
            strSql = "insert into " + strTableName + "(strId, strUserId, strRoleId, intType, strUnitId, strUnitCode, strCreator, dtCreatTime) VALUES (?,?,?,?,?,?,?,str_to_date(?,'%Y-%m-%d %T'))";
            try {
